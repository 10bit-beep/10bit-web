document.addEventListener("DOMContentLoaded", () => {
  ...
  function fetchAndRenderTable(club) {
    const token = localStorage.getItem("token");
    fetch("/clubroom/lookup", {
      method: "POST",
      headers: {
  ...
  if (classSelect) {
    const initialClub = classSelect.options[classSelect.selectedIndex].text;
    fetchAndRenderTable(initialClub);
  ...
  function updateTable(students) {
    ...
    students.forEach((student) => {
      ...
      clubNameCell.className = "class-name";
      clubNameCell.textContent = student.club;
